...
<div id="accordion">
    <div class="container">
        ...
        <c:forEach items="${allowSteps}" var="step">
            <h3>${step.basicStep.functionName} - ${step.basicStep.methodName} - ${step.basicStep.operationName} </h3>
            <div>
                <ol>
                    <c:forEach items="${step.allowSteps}" var="it">
                        <li> ${it.functionName} - ${it.methodName} - ${it.operationName}</li>
                    </c:forEach>
                </ol>
            </div>
        </c:forEach>
